...
describe('RankingCard component', () => {
  it('renders ranking card correctly', () => {
    render(<RankingCard name={PLAYERS_MOCK[0].name} score={PLAYERS_MOCK[0].score} rank={1} />);
  ...
  it('renders ranking card correctly, when index is equal to 2', () => {
    render(<RankingCard name={PLAYERS_MOCK[0].name} score={PLAYERS_MOCK[0].score} rank={2} />);
