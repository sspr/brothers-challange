...
describe('Chip component', () => {
  it('renders chip correctly for cycling', () => {
    render(<DisciplineChip label="bike" />);
  ...
  it('renders chip correctly for running', () => {
    render(<DisciplineChip label="running" />);
  ...
  it('renders chip correctly for swimming', () => {
    render(<DisciplineChip label="swimming" />);
  ...
  it('renders chip correctly for walking', () => {
    render(<DisciplineChip label="walking" />);
  ...
  it('renders chip correctly for elevation', () => {
    render(<DisciplineChip label="elevation" />);
  ...
  it('renders chip correctly for others', () => {
    render(<DisciplineChip label="other" />);
  ...
  it('renders chip correctly for push ups', () => {
    render(<DisciplineChip label="pushUps" />);

    expect(screen.getByText('Push ups')).toBeInTheDocument();
    expect(screen.getByText('Push ups').parentElement).toHaveStyle({ backgroundColor: theme.color.brown });
  });

  it('renders chip correctly for any label', () => {
    render(<DisciplineChip label="koszykówka" />);

    expect(screen.getByText('koszykówka')).toBeInTheDocument();
    expect(screen.getByText('koszykówka').parentElement).toHaveStyle({ backgroundColor: theme.palette.primary.dark });
  });
});
